public class CustomStringMethods {
  ...
  */
  ...
  public String removeCharacter(String myString, int removeIdx) {
    return myString.length() > removeIdx ? myString.substring(0, removeIdx) + myString.substring(removeIdx + 1, myString.length()) : myString;
  }
  ...
  */
  public String insertAt(String orig, String insertText, String searchStr) {
    int i = orig.indexOf(searchStr);
    return i >= 0 ? orig.substring(0, i) + insertText + orig.substring(i, orig.length()) : orig + insertText;
  }
  ...
  */
  public String endUp(String myString, int numToCap){
    ...
    int a = l > numToCap ? numToCap : l;
    return myString.substring(0, l - a) + myString.substring(l - a, l).toUpperCase();
  }
  ...
  */
  ...
  public String starBetween(String str) {
    ...
    return res.substring(0, res.length() - (res.length() < 1 ? 0 : 1));
  }
}